  ...
  return (
    <div className={`${styles.flexBetween} w-[100%]`}>
      <div className={`${styles.flexStart} p-[0.25rem] w-[100%]`}>
        <div
          className={`${styles.flexStart} overflow-scroll gap-[2.5rem] w-[100%]`}
        >
          <div className={`${styles.flexColCenter} relative`}>
            <img src={Ellipse17} alt="" className="min-w-[100%]" />
            <h4 className={`${theme.font} font-lexend font-semibold`}>You</h4>
          ...
          <div className={`${styles.flexColCenter}`}>
            <img src={Ellipse18} alt="" className="min-w-[100%]" />
            <h4 className={`${theme.font} font-lexend font-thin`}>Sam</h4>
          </div>

          <div className={`${styles.flexColCenter}`}>
            <img src={Ellipse19} alt="" className="min-w-[100%]" />
            <h4 className={`${theme.font} font-lexend font-thin`}>Yang</h4>
          </div>

          <div className={`${styles.flexColCenter}`}>
            <img src={Ellipse20} alt="" className="min-w-[100%]" />
            <h4 className={`${theme.font} font-lexend font-thin`}>Rasta</h4>
          </div>

          <div className={`${styles.flexColCenter}`}>
            <img src={Ellipse21} alt="" className="min-w-[100%]" />
            <h4 className={`${theme.font} font-lexend font-thin`}>Director</h4>
          </div>

          <div className={`${styles.flexColCenter} font-thin`}>
            <img src={Ellipse22} alt="" className="min-w-[100%]" />
            <h4 className={`${theme.font} font-lexend font-thin`}>Mia</h4>
          </div>

          <div className={`${styles.flexColCenter} font-thin`}>
            <img src={Ellipse23} alt="" className="min-w-[100%]" />
            <h4 className={`${theme.font} font-lexend font-thin`}>James</h4>
          </div>

          <div className={`${styles.flexColCenter}`}>
            <img src={Ellipse24} alt="" className="min-w-[100%]" />
